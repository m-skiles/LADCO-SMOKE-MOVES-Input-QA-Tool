  ...
  county_map_vmt <- function () {
    ...
    countylist=countylist[countylist %in% county_map$countyID]
    ...
    #define bins to categorize calculated values assign rows to bins
   ...
   #add LADCO footer
     ...
     gg_path=paste(ggsave_countrypath,"\\county_map_vmt.png",sep="")
